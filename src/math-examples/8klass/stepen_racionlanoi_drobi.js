...
const createExample1 = () => {
    ...
    const math = `\\left(\\frac{1}{${variable1}${variable2}}\\right)^{${a}}`
    const answer = `\\frac{1}{${variable1}^{${a}}${variable2}^{${a}}}`
...
const createExample3 = () => {
    ...
    const math = `\\left(\\frac{${variable1}^2}{${variable2}}\\right)^{${a}${b}}`
    const answer = `\\frac{${variable1}^{${2*(a+b)}}}{${variable2}^{${a+b}}}`
    const condition = undefined
...
const createExample4 = () => {
    ...
    const math = `\\left(\\frac{${variable1}}{${variable2}^2}\\right)^{${a}${b}}`
    const answer = `\\frac{${variable1}^{${a+b}}}{${variable2}^{${2*(a+b)}}}`
    const condition = undefined
...
const createExample7 = () => {
    ...
    let variable1 = generateVariableNameOne()
    let variable2 = generateVariableNameTwo()
    const math = `(${b}${variable2}:${variable1})^{${a}}`
    const answer = `\\frac{${b}^{${a}}${variable2}^{${a}}}{${variable1}^{${a}}}`
    const condition = undefined
...
const createExample8 = () => {
    ...
    let otv = '-'
    if(a%2===0) {otv = ''};
    const math = `(${b}:${variable1}${variable2}^2)^{${a}}`
    const answer = `${otv}\\frac{${(-1)*b}^{${a}}}{${variable1}^{${a}}${variable2}^{${2*a}}}`
    const condition = undefined
...
const createExample9 = () => {
    ...
    const answer = `\\frac{${variable1}^{${a}}g^{${a}}}{${variable2}^{${a}}t^{${a}}}`
    const condition = undefined
