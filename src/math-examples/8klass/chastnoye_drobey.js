...
const createExample1 = () => {
    ...
    const math = `\\frac{${variable1}}{t}:\\frac{h}{${variable2}}`
...
const createExample2 = () =>  {
  ...
  const math = `\\frac{${variable1}^{${b}}}{${variable2}}:\\frac{${variable2}}{${variable1}^{${a}}}`
...
const createExample3 = () => {
    ...
    const math = `\\frac{${variable1}^{${b}}}{${variable2}^{${c}}}:\\frac{${variable2}^{${d}}}{${variable1}^{${a}}}`
...
const createExample4 = () =>  {
    ...
    const math = `\\frac{${variable1}^{${b}}}{${variable2}^{${d}}}:\\frac{${variable1}^{${a}}}{${variable2}^{${c}}}`
...
const createExample5 = () => {
    ...
    const math = `\\frac{${variable1}^{${b}}}{${c}}:\\frac{${variable1}^{${a}}}{${d}}`
...
const createExample6 = () => {
    ...
    const math = `\\frac{${variable1}^{${b}}}{${c}${variable2}}:\\frac{${variable1}^{${a}}}{${d}${variable2}}`
    const answer = `\\frac{${variable1}^{${b-a}}}{${c/d}}`
    const condition = undefined
...
const createExample8 = () => {
    ...
    const math = `\\frac{${variable1}^{${b}}}{${c}${variable2}^{${e}}}:(-\\frac{${variable1}^{${a}}}{${d}${variable2}})`
...
const createExample9 = () =>  {
    ...
    const math = `\\frac{${variable2}(${variable1}+${a})}{${b}}:\\frac{${variable1}+${a}}{${variable2}}`
...
const createExample10 = () => {
    ...
    const math = `\\frac{(${variable1}+${a})(${variable1}-${a})}{${b}}:\\frac{${variable2}(${variable1}-${a})}{${b}}`
