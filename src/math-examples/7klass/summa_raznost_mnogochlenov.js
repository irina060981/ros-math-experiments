...
const createExample1 = () => {
    ...
    let d = getRandomInt(2, 15);

    const math = `(${a}${variable1}+${b}${variable1}${variable2})+(${c}${variable1}${variable2}+${d}${variable1})`
    const answer = `${a+d}${variable1}+${b+c}${variable1}${variable2}` 
...
const createExample2 = () => {
    ...
    const math = `(${a}${variable1}-${b}${variable1}${variable2})+(${d}${variable1}-${c}${variable1}${variable2})`
    const answer = `${a+d}${variable1}-${b+c}${variable1}${variable2}` 
    const condition = undefined
