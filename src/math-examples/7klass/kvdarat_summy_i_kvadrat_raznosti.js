...
const createExample5 = () => {
    ...
    const math = `(${a}${variable1}-1)^2`
    const answer = `${a*a}${variable1}^2-${a*2}${variable1}+1`       
    const condition = undefined
...
const createExample7 = () => {
    ...
    const math = `(${a}${variable1}-${b})^2`
    const answer = `${a*a}${variable1}^2-${a*2*b}${variable1}+${b*b}`       
    const condition = undefined
...
const createExample9 = () => {
    ...
    const math = `(${a}${variable1}+${b}${variable2})^2`
    const answer = `${a*a}${variable1}^2+${a*2*b}${variable1}${variable2}+${b*b}${variable2}^2`       
    const condition = undefined
...
const createExample10 = () =>  {
    ...
    const math = `(${a}${variable1}+${b})^2-${2*a*b}${variable1}`
    const answer = `${a*a}${variable1}^2+${b*b}`       
    const condition = undefined
